    ...
    <div className="flex flex-col gap-0 w-full max-w-6xl mx-auto bg-[#0a0a0a] text-[#ffd100] font-serif border-4 border-[#332211] shadow-2xl">
      ...
      <header className="flex flex-col md:flex-row justify-between items-center gap-4 border-b-2 border-[#332211] p-4 md:p-6">
        <div className="flex items-center gap-3">
          ...
          <a
            href="https://github.com/Krosvellos/SWA-dungeon-pipeline"
            target="_blank"
            rel="noopener noreferrer"
            title="GitHub Repository"
            className="ml-1 flex items-center gap-1.5 px-3 py-1.5 text-xs font-bold uppercase border border-[#443322] text-[#888888] hover:border-[#ffd100]/60 hover:text-[#ffd100] transition-colors rounded-sm"
          >
